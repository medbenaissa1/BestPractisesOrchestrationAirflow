...
def notify_valid_records(table: str, **context: Context):
    ...
    valid_records = context["ti"].xcom_pull(task_ids="transform_orders", key="valid_records")
    ### END CODE HERE ###
...
with DAG(
    ...
    start_date=dt.datetime(year=2024, month=12, day=5),
    ### END CODE HERE ###
    ...
    extract_and_load_task = SqlToS3Operator(
        ...
        sql_conn_id="mysql_connection_de",
